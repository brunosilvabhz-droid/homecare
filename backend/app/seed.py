...
def main():
    ...
    with SessionLocal() as db:
        ...
        org=Organization(name="Impacto Care Admin"); db.add(org); db.flush(); db.add(User(name="Administrador",email=email,password_hash=hash_password(password),role=Role.ADMIN,organization_id=org.id)); db.commit()
