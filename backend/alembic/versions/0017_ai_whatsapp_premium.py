...
def upgrade():
    ...
    if not exists: op.bulk_insert(plans,[{"id":"premium-impacto-care-plan-000001","code":"premium","name":"Impacto Care Premium","monthly_price":79.90,"annual_monthly_price":59.90,"active":True,"ai_daily_limit":20,"whatsapp_monthly_limit":100,"per_seat":False,"minimum_seats":1}])
def downgrade():
